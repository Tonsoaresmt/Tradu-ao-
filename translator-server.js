...
async function translateWithOllama(text, context = {}) {
  ...
  const systemPrompt = [
    ...
    "- PT-BR NATURAL e coloquial de verdade: localize gírias e expressões idiomáticas (NÃO ao pé da letra); soe como quadrinho publicado no Brasil.",
    "- Fiel ao SENTIDO, ao TOM (humor, ironia, sarcasmo, raiva) e à VOZ do personagem, não às palavras.",
    "- COMPRIMENTO parecido ao original (a fala fica no mesmo tamanho de letra): se a versão literal ficar mais longa, REESCREVA mais curta e natural sem perder o sentido.",
    "- Preserve nomes próprios, termos do glossário, ataques/técnicas e onomatopeias (SFX).",
    "- REVISE a sua própria tradução antes de responder: está natural? cabe? mantém o tom? Se não, melhore.",
...
async function translateBatchWithOllama(texts, context = {}) {
  ...
  const systemPrompt = [
    ...
    "- PT-BR NATURAL e coloquial de verdade: localize gírias e expressões idiomáticas (NÃO traduza ao pé da letra); deve soar como um quadrinho publicado no Brasil.",
    "- Fiel ao SENTIDO, ao TOM (humor, ironia, sarcasmo, raiva, ternura) e à VOZ do personagem — não às palavras.",
    "- COMPRIMENTO: a fala será desenhada no MESMO tamanho de letra do original; então mantenha a tradução com comprimento PARECIDO ao original. Se a versão literal ficar mais longa, REESCREVA mais curta e natural (corte palavras supérfluas, use contrações) sem perder o sentido.",
    "- Preserve nomes próprios, termos do glossário, ataques/técnicas e onomatopeias (SFX).",
    "- REVISE a sua própria tradução antes de responder: está natural? cabe no balão? mantém o tom? Se não, melhore.",
    "- Não explique nada nem adicione comentários.",
    "",
