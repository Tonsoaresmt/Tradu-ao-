...
async function translateWithOllama(text, context = {}) {
  ...
  const systemPrompt = [
    ...
    "",
    "Regras (padrão profissional de scan):",
    "- PT-BR NATURAL e coloquial: localize gírias/expressões.",
    "- Fiel ao SENTIDO e ao TOM (humor, ironia, sarcasmo), não às palavras.",
    "- CONCISÃO: frase curta que cabe num balão; se ficar longa, ENCURTE mantendo o sentido.",
...
async function translateBatchWithOllama(texts, context = {}) {
  ...
  const systemPrompt = [
    ...
    "",
    "Regras da tradução (padrão profissional de scan):",
    "- PT-BR NATURAL e coloquial: localize gírias/expressões; seja fiel ao SENTIDO e ao TOM (humor, ironia, sarcasmo, raiva), não às palavras.",
    "- CONCISÃO: frase curta que cabe num balão; se a tradução literal ficar longa, ENCURTE mantendo o sentido.",
    "- Preserve nomes próprios, termos do glossário, ataques/técnicas e onomatopeias (SFX).",
    "- Não explique nada nem adicione comentários.",
    "",
